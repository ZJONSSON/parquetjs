...
class ParquetCursor  {
  ...
  /**
   * Retrieve the next RowGroup from the cursor (array or records). 
   * Returns a row or NULL if the end of the file was reached
   */
  async nextRowGroup() {
    if (this.rowGroupIndex >= this.metadata.row_groups.length) {
      return null;
...
class ParquetReader {
  ...
  exportMetadata(indent) {
    return exportMetadata(this.metadata, indent);
  }
